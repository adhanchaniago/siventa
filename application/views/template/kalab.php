            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url('kalab');?>"><i class="fa fa-home fa-fw"></i> Home</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('kalab/inventaris');?>"><i class="fa fa-laptop fa-fw"></i> Inventaris</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('kalab/penempatan');?>"><i class="fa fa-share-square fa-fw"></i> Penempatan</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('kalab/mutasi');?>"><i class="fa fa-retweet fa-fw"></i> Mutasi</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('kalab/label');?>"><i class="fa fa-tag fa-fw"></i> Label</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('kalab/laporan');?>"><i class="fa fa-file-alt fa-fw"></i> Laporan</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
