            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url('guest');?>"><i class="fa fa-home fa-fw"></i> Home</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('guest/lokasi');?>"><i class="fa fa-map-marker-alt fa-fw"></i> Lokasi</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('guest/inventaris');?>"><i class="fa fa-laptop fa-fw"></i> Inventaris</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('guest/penempatan');?>"><i class="fa fa-share-square fa-fw"></i> Penempatan</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('guest/mutasi');?>"><i class="fa fa-retweet fa-fw"></i> Mutasi</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
