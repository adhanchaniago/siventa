            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url('admin');?>"><i class="fa fa-home fa-fw"></i> Home</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('admin/user');?>"><i class="fa fa-users fa-fw"></i> Manajemen User</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('admin/lokasi');?>"><i class="fa fa-map-marker-alt fa-fw"></i> Manajemen Lokasi</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('admin/inventaris');?>"><i class="fa fa-laptop fa-fw"></i> Inventaris</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('admin/penempatan');?>"><i class="fa fa-share-square fa-fw"></i> Penempatan</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('admin/mutasi');?>"><i class="fa fa-retweet fa-fw"></i> Mutasi</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('admin/label');?>"><i class="fa fa-tag fa-fw"></i> Label</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('admin/laporan');?>"><i class="fa fa-file-alt fa-fw"></i> Laporan</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
